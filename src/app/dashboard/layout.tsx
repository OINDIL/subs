...
const navItems = [
  { href: "/dashboard", label: "My Subscriptions", icon: <ClipboardList className="w-5 h-5" /> },
  { href: "/dashboard/memberships", label: "My Memberships", icon: <Users className="w-5 h-5" /> },
